...
def visualize_test_results(all_images, true_labels, point_predictions, prediction_sets, 
    ...
    plt.tight_layout()
    plt.savefig('model_free/conformal_prediction_results.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_statistics(prediction_sets, true_labels, point_predictions, all_probabilities, alpha):
    ...
    plt.tight_layout()
    plt.savefig('model_free/conformal_prediction_statistics.png', dpi=300, bbox_inches='tight')
    plt.show()
