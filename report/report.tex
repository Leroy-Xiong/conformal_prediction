...
However, CP remains unaffected by the skewness. By computing the nonconformity scores directly from the data and determining the threshold empirically (Panel c), it achieves a coverage of 90.8\%, aligning almost perfectly with the target. This confirms that CP provides valid uncertainty quantification for arbitrary data distributions without requiring feature engineering or complex density estimation.
